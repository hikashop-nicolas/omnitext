...
import { sqliteViewer } from "./editors/sqliteviewer";
import { ipynbViewer } from "./editors/ipynbviewer";
import { emailViewer } from "./editors/emailviewer";
import { pimViewer } from "./editors/pimviewer";
import { tiffViewer } from "./editors/tiffviewer";
import { torrentViewer } from "./editors/torrentviewer";
import { model3dViewer } from "./editors/model3dviewer";
import { parquetViewer } from "./editors/parquetviewer";
import { heicViewer } from "./editors/heicviewer";
import { ebookViewer } from "./editors/ebookviewer";
import { dxfViewer } from "./editors/dxfviewer";
import { dicomViewer } from "./editors/dicomviewer";
import { recordsViewer } from "./editors/recordsviewer";
import { rawViewer } from "./editors/rawviewer";
...
import { sqliteFormat } from "./formats/sqlite";
import { ipynbFormat } from "./formats/ipynb";
import { emlFormat } from "./formats/eml";
import { msgFormat } from "./formats/msg";
import { icsFormat } from "./formats/ics";
import { vcfFormat } from "./formats/vcf";
import { tiffFormat } from "./formats/tiff";
import { torrentFormat } from "./formats/torrent";
import { model3dFormat } from "./formats/model3d";
import { parquetFormat } from "./formats/parquet";
import { heicFormat } from "./formats/heic";
import { ebookFormat } from "./formats/ebook";
import { dxfFormat } from "./formats/dxf";
import { dwgFormat } from "./formats/dwg";
import { dicomFormat } from "./formats/dicom";
...
engine.registerEditor(sqliteViewer);
engine.registerEditor(ipynbViewer);
engine.registerEditor(emailViewer);
engine.registerEditor(pimViewer);
engine.registerEditor(tiffViewer);
engine.registerEditor(torrentViewer);
engine.registerEditor(model3dViewer);
engine.registerEditor(parquetViewer);
engine.registerEditor(heicViewer);
engine.registerEditor(ebookViewer);
engine.registerEditor(dxfViewer);
engine.registerEditor(dicomViewer);
engine.registerEditor(recordsViewer);
engine.registerEditor(rawViewer);
...
// Data/design/PIM viewers (open-only). ipynb/ics/vcf are text (raw editing via the text
// editor); font/sqlite/eml/msg/tiff/torrent are binary.
engine.registerFormat(fontFormat);
engine.registerFormat(sqliteFormat);
engine.registerFormat(ipynbFormat);
engine.registerFormat(emlFormat);
engine.registerFormat(msgFormat);
engine.registerFormat(icsFormat);
engine.registerFormat(vcfFormat);
engine.registerFormat(tiffFormat);
engine.registerFormat(torrentFormat);
engine.registerFormat(model3dFormat);
engine.registerFormat(parquetFormat);
engine.registerFormat(heicFormat);
engine.registerFormat(ebookFormat);
engine.registerFormat(dxfFormat);
engine.registerFormat(dwgFormat);
engine.registerFormat(dicomFormat);
engine.registerFormat(arrowFormat);
engine.registerFormat(rawFormat);
