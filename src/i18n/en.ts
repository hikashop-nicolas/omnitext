...
const en: Dict = {
  app: {
    ...
    themeLight: "Light",
    themeDark: "Dark",
    aiDownloads: "Downloads for AI features",
    aiAsk: "Ask first",
    aiAllow: "Allowed",
    aiDeny: "Not allowed",
    aiHint: "Text recognition, translation, the writing assist and transcription download a model the first time they are used. Your files are never sent.",
  ...
  notify: {
    ...
    archiveNotWritable: "Omnitext can read {name} but cannot write it back, so this file cannot be saved into it. Use Download to keep your changes as a separate file.",
  ...
  consent: {
    ...
    allow: "Allow",
    deny: "Don't allow",
    turnedOff: "Downloads for AI features are turned off. You can allow them in Settings.",
    feature: {
      ocr: "Text recognition",
      translate: "Translation",
      generate: "The writing assist",
  ...
  tree: {
    ...
    kindList: "list [ ]",
    kindObject: "object { }",
    kindLocked: "Remove entries first: converting would lose data.",
  },
  binary: {
    download: "Download",
    ...
    askHint: "Tell us what this file is, and Omnitext may learn to open it. The button opens a page on our feedback tracker, with the file type already filled in; writing there needs a free account. Nothing from the file itself is sent.",
