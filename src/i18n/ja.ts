...
const ja: Dict = {
  ...
  binary: {
    ...
    askHint: "どのようなファイルか教えていただければ、Omnitext で開けるようになるかもしれません。ボタンを押すと、Omnitext のコードを公開している GitHub というサイトのページが、ファイルの種類を入力済みの状態で開きます。書き込むには無料のアカウントが必要です。ファイルの内容は一切送信されません。",
